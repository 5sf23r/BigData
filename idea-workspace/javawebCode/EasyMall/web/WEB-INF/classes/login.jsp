	...
	<body>
		...
		<form action="/LoginServlet" method="POST">
			<table>
				...
				<tr>
					<td colspan="2">
						<input type="checkbox" name="t1" />1
						<input type="checkbox" name="t2" />2
						<input type="checkbox" name="t3" />3
						<input type="checkbox" name="t4" />4
						<input type="checkbox" name="t5" />5
						<input type="checkbox"
							   <%= "".equals(username) ? "" : "checked" %>
