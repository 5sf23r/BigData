...
import cn.tedu.sortscore.SortScoreDriver;
import cn.tedu.sortscore.SortScoreReducer;
...
//        FileInputFormat.setMaxInputSplitSize();
        FileInputFormat.addInputPath(job,new Path("hdfs://hadoop01:9000/txt/profit3.txt"));
        FileOutputFormat.setOutputPath(job,new Path("hdfs://hadoop01:9000/result/sortprofit2"));
